...
describe('Service Tests', () => {
    describe('TaskExecution Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new TaskExecution(0, currentDate);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a TaskExecution', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        timestamp: currentDate.format(DATE_TIME_FORMAT)
            ...
            it('should update a TaskExecution', async () => {
                const returnedFromService = Object.assign(
                    {
                        timestamp: currentDate.format(DATE_TIME_FORMAT)
                    },
            ...
            it('should return a list of TaskExecution', async () => {
                const returnedFromService = Object.assign(
                    {
                        timestamp: currentDate.format(DATE_TIME_FORMAT)
                    },
            ...
            it('should delete a TaskExecution', async () => {
